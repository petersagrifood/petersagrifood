        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-3 flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              <p className="truncate text-xs font-bold text-slate-900">Nguyễn Minh Quân</p>
              <p className="truncate text-[10px] text-slate-500">Tổ trưởng / Quản lý</p>
            </div>
          </div>
          <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-green-600 py-2 text-xs font-bold text-white transition-all hover:bg-green-700 active:scale-[0.98]">
